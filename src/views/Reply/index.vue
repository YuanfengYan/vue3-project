    ...
    <div class="app-container">
      ...
      >
        ...
        <el-table-column label="操作" align="center">
          <template #default="scope">
            <el-button size="mini" type="primary" @click="changeStatus(scope.row.id, 1)">
              审核通过
            </el-button>
            <el-button size="mini" type="warning" @click="changeStatus(scope.row.id, 2)">
              审核不通过
            </el-button>
...
<script>
import { list, detele2, update } from "@/api/blog/reply";
