    ...
    <div class="search">
      <el-form ref="searchForm" v-loading="listLoading" :model="searchForm" inline>
        ...
        <el-form-item>
          ...
          <el-button type="primary" size="medium" @click="create"> 新增文章 </el-button>
        </el-form-item>
      </el-form>
    </div>
...
<script>
import { list, detele } from "@/api/blog/article";
import { list as getCategoryList } from "@/api/blog/category";
